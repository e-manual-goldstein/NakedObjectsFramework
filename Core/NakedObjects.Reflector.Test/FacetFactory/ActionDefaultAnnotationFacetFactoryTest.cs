...
namespace NakedObjects.Reflect.Test.FacetFactory {
    ...
    public class ActionDefaultAnnotationFacetFactoryTest : AbstractFacetFactoryTest {
        ...
        public void TestPropertyDefaultAnnotationPickedUpOnActionParameter() {
            ...
            Assert.AreEqual(1, actionDefaultFacetAnnotation.GetDefault(null, null, null).Item1);
            Assert.AreEqual(TypeOfDefaultValue.Explicit, actionDefaultFacetAnnotation.GetDefault(null, null, null).Item2);
        }
    }
